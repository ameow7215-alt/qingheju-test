const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./HomeView-C25YwMSN.js","./_plugin-vue_export-helper-1tPrXgE0.js","./HomeView-BX5XvdFd.css","./QuizView-BSaLTFER.js","./dataLoader-Dc-FQg60.js","./QuizView-CklqSUre.css","./ResultView-DbORP8Xc.js","./ResultView-By7KRPyd.css"])))=>i.map(i=>d[i]);
(function polyfill() {
...
const _hoisted_1 = { class: "min-h-screen bg-gradient-to-b from-amber-50 to-orange-100" };
...
const routes = [
  {
    path: "/",
    name: "Home",
    component: () => __vitePreload(() => import("./HomeView-C25YwMSN.js"), true ? __vite__mapDeps([0,1,2]) : void 0, import.meta.url)
  },
  {
    path: "/quiz",
    name: "Quiz",
    component: () => __vitePreload(() => import("./QuizView-BSaLTFER.js"), true ? __vite__mapDeps([3,1,4,5]) : void 0, import.meta.url)
  },
  {
    path: "/result",
    name: "Result",
    component: () => __vitePreload(() => import("./ResultView-DbORP8Xc.js"), true ? __vite__mapDeps([6,4,1,7]) : void 0, import.meta.url)
  }
];
const router = createRouter({
  history: createWebHistory("/ancient-test/"),
  routes
});
...
//# sourceMappingURL=index-dZW530NG.js.map
