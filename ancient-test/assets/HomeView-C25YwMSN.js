import { d as defineComponent, c as createElementBlock, a as createBaseVNode, n as normalizeStyle, u as unref, b as createStaticVNode, e as useRouter, o as openBlock } from "./index-dZW530NG.js";
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1, [
        ...
        createBaseVNode("div", _hoisted_5, [
          _cache[1] || (_cache[1] = createStaticVNode('<h1 class="text-3xl font-medium text-[#2c3e50] text-center mb-6 font-calligraphy" data-v-d839a655> 寻古问心·照见本真 </h1><p class="text-base text-[#2c3e50] text-center opacity-80 mb-8 subtitle-font" data-v-d839a655> 一次基于道家五行智慧的深度自我探索 </p><div class="flex flex-col gap-5 mb-10 w-full max-w-sm" data-v-d839a655><div class="flex flex-col" data-v-d839a655><p class="text-sm font-medium text-[#2c3e50]" data-v-d839a655> · 在快节奏中，给自己一次&quot;向内观照&quot;的机会 </p><p class="text-xs text-[#2c3e50] opacity-60 ml-3 mt-1" data-v-d839a655> 30道精选题目，约3-5分钟完成 </p></div><div class="flex flex-col" data-v-d839a655><p class="text-sm font-medium text-[#2c3e50]" data-v-d839a655> · 探寻出世入世间的平衡之道 </p><p class="text-xs text-[#2c3e50] opacity-60 ml-3 mt-1" data-v-d839a655> 融合道家五行智慧，发现你的心性特质 </p></div><div class="flex flex-col" data-v-d839a655><p class="text-sm font-medium text-[#2c3e50]" data-v-d839a655> · 获得专属&quot;心镜&quot;，照见内在的五行平衡 </p><p class="text-xs text-[#2c3e50] opacity-60 ml-3 mt-1" data-v-d839a655> 生成详细古代身份卡，内含性格分析与成长指引 </p></div></div>', 3)),
...
const HomeView = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-d839a655"]]);
export {
  HomeView as default
};
//# sourceMappingURL=HomeView-C25YwMSN.js.map
